/**
 * WsIcon — Lucide-style SVG icon component for workspace components.
 * Replaces emoji icons with consistent, professional SVG icons.
 * Usage: <WsIcon name="building-2" size={16} />
 */
...
const PATHS = {
  ...
  // WAT / Audit
  'clipboard-list': <><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="15" y2="16"/><polyline points="9 9 10 9 11 9"/></>,
  ...
  'campaign':      <><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></>,
  'play':          <><polygon points="5 3 19 12 5 21 5 3"/></>,
};

export default function WsIcon({ name, size = 16, color = 'currentColor', style = {} }) {
